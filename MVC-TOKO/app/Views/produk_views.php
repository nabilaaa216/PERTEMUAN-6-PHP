  ...
  <body>
    <div class="container">
        ...
        <!-- tambah tombol tambah data -->
         <a href="index.php?action=tambah_produk" class="btn btn-success mb-3">Tambah Produk</a>
         <hr>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?action=edit_produk&kode_barang=<?php echo $dataBarang['kode_barang'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="index.php?action=hapus_produk&kode_barang=<?php echo $dataBarang['kode_barang'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau hapus data ini?')">Hapus</a>
                    </td>
                </tr>
                <?php
                endforeach;
